                        ...
                        @foreach ($products as $key => $product)
                            <tr data-entry-id="{{ $product->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('admin.products.destroy', $product->id) }}" method="POST" data-confirm-msg="{{ trans('global.areYouSure') }}" data-confirm-title="Eliminar" data-confirm-icon="warning" data-confirm-yes="Sí, eliminar" style="display: inline-block;">
