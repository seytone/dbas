				...
				<div class="row">
					<div class="col-sm-2">
						<div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
							...
							<input type="text" id="code" name="code" class="form-control" value="{{ old('code') }}" maxlength="50" required>
							@if ($errors->has('code'))
					...
					<div class="col-sm-12">
						<div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
							...
							<input type="text" id="title" name="title" class="form-control title" value="{{ old('title') }}" maxlength="200" required>
							@if ($errors->has('title'))
								<em class="invalid-feedback">
									{{ $errors->first('title') }}
								</em>
					...
					<div class="col-sm-12">
						<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
							...
							<textarea id="description" name="description" rows="2" class="form-control description resume" maxlength="500">{{ old('description') }}</textarea>
