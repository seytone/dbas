...
<div class="rates-widget bg-light border rounded px-3 py-2 mt-2 mt-md-0">
	<div class="d-flex align-items-center flex-wrap" style="gap: 8px;">
		{{-- Dot + label los actualiza el JS de create/edit según el estado
		     (live = tasas del día actualizadas · verde, frozen = tasas
		     congeladas de esta cotización · naranja). --}}
		<span id="rates-dot" style="display:inline-block;width:9px;height:9px;border-radius:50%;background:#adb5bd;"></span>
		<span class="text-muted" style="font-size: 12px;" id="rates-label"><i class="fa fa-cog mr-1"></i><b>Tasas del día</b></span>
