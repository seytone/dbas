			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="number" name="subtotal" id="subtotal" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="number" name="discount_1_amount" id="discount_1_amount" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="number" name="discount_2_amount" id="discount_2_amount" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row">
				...
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="number" name="tax_exempt" id="tax_exempt" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>Base Imponible</b></label>
						<div class="col-sm-7">
							<input type="number" name="tax_base" id="tax_base" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>IVA (<span id="iva_label">16</span>%)</b></label>
						<div class="col-sm-7">
							<input type="number" name="iva_amount" id="iva_amount" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>IGTF</b></label>
						<div class="col-sm-7">
							<input type="number" name="igtf_amount" id="igtf_amount" class="form-control text-right" step="0.01" value="0.00" readonly>
						</div>
					</div>
					<div class="form-group row bg-light p-2 rounded">
						...
						<div class="col-sm-7">
							<input type="number" name="total" id="total" class="form-control text-right font-weight-bold" step="0.01" value="0.00" readonly style="font-size: 1.2em;">
						</div>
					</div>
				</div>
			</div>
