		...
		<form action="{{ route('admin.quotations.store') }}" method="POST" id="quotation-form">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input type="text" name="quotation_number" id="quotation_number" class="form-control" value="{{ $nextNumber }}" readonly>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<small class="text-muted">Selecciona un cliente existente para editar sus datos, o limpia el selector para crear uno nuevo.</small>
					</div>
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<textarea name="notes" id="notes" class="form-control" rows="3" placeholder="Nota al pie de la cotización..."></textarea>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text" name="subtotal" id="subtotal" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="discount_1_amount" id="discount_1_amount" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="discount_2_amount" id="discount_2_amount" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>Flete</b></label>
						<div class="col-sm-7">
							<input type="text" name="freight" id="freight" class="form-control text-right" inputmode="decimal" value="{{ old('freight', '0,00') }}">
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text" name="tax_exempt" id="tax_exempt" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>Base Imponible</b></label>
						<div class="col-sm-7">
							<input type="text" name="tax_base" id="tax_base" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>IVA (<span id="iva_label">16</span>%)</b></label>
						<div class="col-sm-7">
							<input type="text" name="iva_amount" id="iva_amount" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-5 col-form-label"><b>IGTF</b></label>
						<div class="col-sm-7">
							<input type="text" name="igtf_amount" id="igtf_amount" class="form-control text-right" value="0,00" readonly>
						</div>
					</div>
					<div class="form-group row bg-light p-2 rounded">
						...
						<div class="col-sm-7">
							<input type="text" name="total" id="total" class="form-control text-right font-weight-bold" value="0,00" readonly style="font-size: 1.2em;">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12 text-right">
					...
					<button type="submit" class="btn btn-success"><i class="fa fa-save mr-2"></i>Guardar Cotización</button>
				</div>
			</div>
		</form>
	</div>
...
$(function() {
	...
	// "Limpiar para nuevo cliente" button
	...
	// ========================================
	// Selectors for visible money inputs that get formatted/unformatted.
	...
	function parseMoney(value) {
		...
		if (hasComma) {
			...
			// More than one dot → Spanish thousands separator. Single dot with
			// 3 digits after and 1–3 before could be ambiguous; treat as thousands.
	...
	// Convert all visible formatted money inputs to raw numeric values
	// (dot decimal, no thousands) before form submission, so backend gets clean numbers.
	...
	// Re-format on blur (and on demand). Skips empty inputs.
	...
	// ========================================
	// TEXT NORMALIZATION (replace smart dashes/quotes that may break rendering)
	// ========================================
	...
	@if(is_array(old('extra_charges')))
		@foreach(old('extra_charges') as $charge)
	...
	// Global discount and freight handlers
	...
	$('#quotation-form').on('submit', function(e) {
		...
		// Tributos cleared by the user mid-edit was producing intermittent
		// "campo tributos debe ser obligatorio" errors on first submit.
