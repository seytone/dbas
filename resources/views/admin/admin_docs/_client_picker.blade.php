...
<div class="form-group">
	...
	<div class="d-flex">
		...
		<button type="button" class="btn btn-outline-secondary" id="btn-clear-client" title="Limpiar y capturar cliente nuevo">
			<i class="fa fa-user-plus"></i>
		</button>
	</div>
	<small class="text-muted">Selecciona un cliente existente para autollenar sus datos, o limpia el selector para capturar uno nuevo manualmente.</small>
</div>
