			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
						...
						<textarea id="description" name="description" rows="1" class="form-control description" maxlength="140">{{ old('description', isset($category) ? $category->description : '') }}</textarea>
