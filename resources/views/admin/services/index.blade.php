                        ...
                        @foreach ($services as $key => $service)
                            <tr data-entry-id="{{ $service->id }}">
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-primary m-1" href="{{ route('admin.services.show', $service->id) }}" title="VER">
                                        <i class="fa fa-fw fa-eye" aria-hidden="true"></i>
                                    </a>
                                    <a class="btn btn-sm btn-warning m-1" href="{{ route('admin.services.edit', $service->id) }}" title="EDITAR">
                                        <i class="fa fa-fw fa-wrench" aria-hidden="true"></i>
                                    </a>
                                    <form action="{{ route('admin.services.destroy', $service->id) }}" method="POST" data-confirm-msg="{{ trans('global.areYouSure') }}" data-confirm-title="Eliminar" data-confirm-icon="warning" data-confirm-yes="Sí, eliminar" style="display: inline-block;">
